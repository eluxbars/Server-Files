...
var guildId = "975490533344559154"; // Guild ID for a Discord Server, see https://faxes.zone/i/zjKnd.png
var botToken = "OTc1NTM0MDEwNjc3NzI3MjQz.GnydU5.vVuTyM1FFraN7IXheuPYGb8bEB3f_AiVYr2vxs"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
...
var notWhitelistedMessage = "Please join discord.io/globaldm and verify to join the server.";
var noGuildMessage = "You require discord to be open and join discord.io/globaldm and verify to join the server.";
var blacklistMessage = "You're blacklisted from this server.";
var debugMode = false; // 
var cacheMaxTime = "20s"; // This is the time it takes for refreshes (cache) to have to reload when fetching Discord roles.
