...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("GDM:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("GDM:setHairstyle")
AddEventHandler("GDM:setHairstyle",function(hairstyle)
    if hairstyle then
...
RegisterNetEvent('GDM:openBarberShop')
AddEventHandler('GDM:openBarberShop', function()
