...
vRPclient = Tunnel.getInterface("vRP", "Blackjack")
            ...
            if tonumber(betAmount) then
                ...
                if betAmount > 0 then
                    if tryTakeChips(source,betAmount) then
                        ...
                        TriggerClientEvent("blackjack:notify",source,"~g~Bet placed: " ..getMoneyStringFormatted(tostring(betAmount)).. " credits.")
                    else 
                        TriggerClientEvent("blackjack:notify",source,"~r~Not enough money!")
                    end
                end
            end
        end
                                        ...
                                        while nextCardCount >= 1 do
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    TriggerClientEvent("blackjack:notify",source,"~r~-"..tostring(lostAmount).." credits")
                                                    TriggerClientEvent("vrp:PlaySound", source, "casino_lose")
                                                    local webhook = 'https://discord.com/api/webhooks/976250576499257365/EPcKzJ1h8DOEbd6jCJ_o6Wxk-gVu0NS_5rD9-pOs_2tsykkhzjtuFbZeHnr9r-9g49wh'
                                                    local embed = {
                                                        {
                                                            ["color"] = "16777215",
                                                            ["title"] = "Casino Logs",
                                                            ["description"] = "**User Name:** "..GetPlayerName(source).."\n**User ID:** "..vRP.getUserId({source}).."\n**Outcome: Loss**\n**Amount:** "..tostring(getMoneyStringFormatted(lostAmount)),
                                                            ["footer"] = {
                                                                ["text"] = "GDM - "..os.date("%X"),
                                                            },
                                                        }
                                                    }
                                                        PerformHttpRequest(webhook, function (err, text, headers) end, 'POST', json.encode({username = 'GDM', embeds = embed}), { ['Content-Type'] = 'application/json' })
                                                    if lostAmount > 10000000 then
                                                        TriggerClientEvent('chatMessage', -1, "^1Diamond Casino | ^7" .. GetPlayerName(source) .. " has ^1LOST ^7" .. tostring(getMoneyStringFormatted(lostAmount)) .. " ^7in the casino!" , "alert")                                       
                                                    end
                                                ...
                                                if dealerHand > 21 then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("blackjack:notify",source,"~g~+"..getMoneyStringFormatted(tostring(potentialWinAmount)).." credits")
                                                            ...
                                                            local embed = {
                                                                {
                                                                    ["color"] = "16777215",
                                                                    ["title"] = "Casino Logs",
                                                                    ["description"] = "**User Name:** "..GetPlayerName(source).."\n**User ID:** "..vRP.getUserId({source}).."\n**Outcome: Win**\n**Amount:** "..tostring(getMoneyStringFormatted(potentialPushAmount)),
                                                                    ["footer"] = {
                                                                        ["text"] = "GDM - "..os.date("%X"),
                                                                    },
                                                                }
                                                            ...
                                                            if potentialPushAmount > 10000000 then
                                                                TriggerClientEvent('chatMessage', -1, "^1Diamond Casino | ^7" .. GetPlayerName(source) .. " has ^2WON ^7" .. tostring(getMoneyStringFormatted(potentialPushAmount)) .. "^7 in the casino!", "alert")
                                                            end
                                                        end
                                                    end
                                                ...
                                                elseif currentHand > dealerHand and currentHand <= 21 then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            local embed = {
                                                                {
                                                                    ["color"] = "16777215",
                                                                    ["title"] = "Casino Logs",
                                                                    ["description"] = "**User Name:** "..GetPlayerName(source).."\n**User ID:** "..vRP.getUserId({source}).."\n**Outcome: Win**\n**Amount:** "..tostring(getMoneyStringFormatted(potentialWinAmount)),
                                                                    ["footer"] = {
                                                                        ["text"] = "GDM - "..os.date("%X"),
                                                                    },
                                                                }
                                                            ...
                                                            PerformHttpRequest(webhook, function (err, text, headers) end, 'POST', json.encode({username = 'GDM', embeds = embed}), { ['Content-Type'] = 'application/json' })
                                                            if potentialWinAmount > 10000000 then
                                                                TriggerClientEvent('chatMessage', -1, "^1Diamond Casino | ^7" .. GetPlayerName(source) .. " has ^2WON ^7" .. tostring(getMoneyStringFormatted(potentialPushAmount)) .. "^7 in the casino!", "alert")
                                                            end
                                                        end
                                                    end
                                                ...
                                                elseif currentHand == dealerHand then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("blackjack:notify",source,"~b~+0 credits")
                                                        end
                                                    end
                                                else
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("blackjack:notify",source,"~r~-"..getMoneyStringFormatted(tostring(potentialPushAmount)).." credits")
                                                            TriggerClientEvent("vrp:PlaySound", source, "casino_lose")
                                                            local webhook = 'https://discord.com/api/webhooks/976250576499257365/EPcKzJ1h8DOEbd6jCJ_o6Wxk-gVu0NS_5rD9-pOs_2tsykkhzjtuFbZeHnr9r-9g49wh'
                                                            local embed = {
                                                                {
                                                            ...
                                                            PerformHttpRequest(webhook, function (err, text, headers) end, 'POST', json.encode({username = 'GDM', embeds = embed}), { ['Content-Type'] = 'application/json' })
                                                            if potentialPushAmount > 10000000 then
                                                                TriggerClientEvent('chatMessage', -1, "^1Diamond Casino | ^7" .. GetPlayerName(source) .. " has ^1LOST ^7" .. tostring(getMoneyStringFormatted(potentialPushAmount)) .. "^7 in the casino!" , "alert")
                                                            end
                                                        end
                                                    end
                                                end
