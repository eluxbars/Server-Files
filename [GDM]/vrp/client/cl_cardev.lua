                ...
                if b then
                    RageUI.Checkbox("Return to normal Universe", "~r~Leave Car Dev Mode", b, {}, function(Hovered, Active, Selected, Checked)
                        if Selected then
                            ...
                            DoScreenFadeIn(1000)
                            b=false
                            TriggerServerEvent("GDM:setCarDev",b)
                        end
                    end)
                else
...
RegisterCommand('cardev', function()
    TriggerServerEvent('GDM:openCarDev')
end)

RegisterNetEvent("GDM:CarDevMenu")
AddEventHandler("GDM:CarDevMenu",function()
...
function TakeVehScreenshot()
    ...
    Wait(3000)
    TriggerServerEvent('GDM:takeCarScreenshot', veh, 'front')
    Wait(5000)
    SetGameplayCamRelativeHeading(0.8)
    TriggerServerEvent('GDM:takeCarScreenshot', veh, 'rear')
    Wait(5000)
    SetGameplayCamRelativeHeading(92.0)
    TriggerServerEvent('GDM:takeCarScreenshot', veh, 'side')
    Wait(5000)
    TakingCarSS = false
