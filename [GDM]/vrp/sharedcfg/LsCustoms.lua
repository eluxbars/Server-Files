...
------Neon layout------
	...
	xenoncolor = {
		{ name = "White", xenon = 0, price = 0},
		{ name = "Blue", xenon = 1, price = 0},
		{ name = "Electric Blue", xenon = 2, price = 0},
		{ name = "Mint Green", xenon = 3, price = 0},
		{ name = "Lime Green", xenon = 4, price = 0},
		{ name = "Yellow", xenon = 5, price = 0},
		{ name = "Golden Shower", xenon = 6, price = 0},
		{ name = "Orange", xenon = 7, price = 0},
		{ name = "Red", xenon = 8, price = 0},
		{ name = "Pony Pink", xenon = 9, price = 0},
		{ name = "Hot Pink",xenon = 10, price = 0},
		{ name = "Purple", xenon = 11, price = 0},
		{ name = "Blacklight", xenon = 12, price = 0},
	},
...
----Wheel accessories----
	wheelaccessories = {
		...
		{ name = "Bulletproof Tires", price = 0},
...
-----------Horn----------
	[14] = {
		...
		{name = "Police Horn", mod = 1, price = 0},
