...
RegisterServerEvent("GDM:GiveMoney")
AddEventHandler("GDM:GiveMoney", function()
  local player = source
        ...
        if nuser_id ~= nil then
          ...
          vRP.prompt(player,lang.money.give.prompt(),"",function(player,amount)
            ...
            if amount > 0 and vRP.tryPayment(user_id,amount) then
              ...
              webhook = "https://discord.com/api/webhooks/946672162771709982/Znjhs9U1qQ0MqEtzbxvNvbUopJu6Fnb5Y8klKnsAobW6XHAnELnBVYq3o1jVJO9ZisxM"
