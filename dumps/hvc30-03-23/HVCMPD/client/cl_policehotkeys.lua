...
RegisterNetEvent('HVC:policeHotkeysTrue')
AddEventHandler('HVC:policeHotkeysTrue', function() 
    handcuffed = true
end)

RegisterNetEvent('HVC:policeHotkeysFalse')
AddEventHandler('HVC:policeHotkeysFalse', function() 
    handcuffed = false
end)
...
RegisterNetEvent("HVC:cuffAnimPolice")
AddEventHandler("HVC:cuffAnimPolice", function(nplayer, player)
    local player = player
    local nplayer = nplayer
    TriggerServerEvent("HVC:PlayWithinDistance", 0.2 , "cuffing", 1, GetEntityCoords(GetPlayerPed(-1))) 
...
RegisterNetEvent("HVC:cuffAnimPerp")
AddEventHandler("HVC:cuffAnimPerp", function()
...
RegisterNetEvent("HVC:drag")
AddEventHandler('HVC:drag', function(pl)
    other = pl
    drag = not drag
end)

RegisterNetEvent("HVC:undrag")
AddEventHandler('HVC:undrag', function(pl)
    drag = false
end)
