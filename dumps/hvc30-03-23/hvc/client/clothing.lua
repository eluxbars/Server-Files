RMenu.Add('HVCClothing', 'main', RageUI.CreateMenu("", "~b~Clothing Menu", 1300,100, "banners", "clothes"))
RMenu.Add('HVCClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("HVCClothing", "main")))
RMenu.Add('HVCClothing', 'hair',  RageUI.CreateSubMenu(RMenu:Get("HVCClothing", "clothingsubmenu")))
RMenu.Add('HVCClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("HVCClothing", "main")))
RMenu.Add('HVCClothing', 'changepedmenu',  RageUI.CreateSubMenu(RMenu:Get("HVCClothing", "main")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('HVCClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Button("Change Clothing", "", {}, true, function(Hovered, Active, Selected) end, RMenu:Get("HVCClothing", "clothingsubmenu"))
            RageUI.Button("Change Gender", "", {}, true, function(Hovered, Active, Selected) end, RMenu:Get("HVCClothing", "changegendersubmenu"))
            RageUI.Button("~g~Change Ped", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("HVCClothing", "changepedmenu"))
        end)
    end
    if RageUI.Visible(RMenu:Get('HVCClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.Button("Female", "", {}, true, function(Hovered, Active, Selected) 
                if Selected then 
                    ...
                    if GetEntityHealth(PlayerPedId()) > 102 then
                        ...
                        TriggerServerEvent("HVC:LoadPlayerSets")
                    else
                        notify("~r~You cannot change gender while dead.")
                    end
                end
            end,RMenu:Get("HVCClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('HVCClothing', 'changepedmenu')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('HVCClothing', 'clothingsubmenu')) then
        ...
        if IsControlJustPressed(0, 203) then 
                ...
                if (GetOnscreenKeyboardResult()) then
                    ...
                    if PlayerData then 
                        Hair.TextureIndex = PlayerData['haircolor']
                    else
                        Hair.TextureIndex = 0
                    end
        ...
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            ...
            if PlayerData and PlayerData['haircolor'] then
                RageUI.Button("Features", "", { RightLabel = ">>>" }, true, function(Hovered, Active, Selected)

                end, RMenu:Get("HVCClothing", "hair"))
            else
                RageUI.Button("Features", "~r~You must visit the barbers to be able to use this feature @ clothing stores", { RightLabel = ">>>" }, false, function(Hovered, Active, Selected)
    ...
    if RageUI.Visible(RMenu:Get('HVCClothing', 'hair')) then 
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            DrawAdvancedText(0.870, 0.850, 0.005, 0.0028, 0.4, 'Press SPACE to input an ID',  255, 255, 255, 255, 6, 0)
            if IsControlJustPressed(0, 203) then 
                    AddTextEntry('FMMC_MPM_NA', "Enter Clothing ID")
            ...
            RageUI.List("Hair", Hair.Max, Hair.Index, "", { }, true, function(Hovered, Active, Selected, Index)
                ...
                if Active then
                    SelectedOption = 2;
                    PlayerData['hair'] = Hair.Index
                    SetPedComponentVariation(PlayerPedId(), 2, Hair.Index, 0, 0)
                end
                if Selected then 
                    TriggerServerEvent("HVC:SavePedData", PlayerData)
                end
            end)

            RageUI.Button("Hair Color", 'Texture Index: ' .. PlayerData['haircolor'] .. "/" .. GetNumHairColors(), { RightLabel = ">>>" }, true, function(Hovered, Active, Selected)
                if Active then
                    SelectedOption = 2;
                    --rawAdvancedText(0.863, 0.809, 0.005, 0.0028, 0.4, 'Texture Index: ' .. PlayerData['haircolor'] .. "/" .. GetNumHairColors(),  255, 255, 255, 255, 6, 0)
                    PlayerData['haircolor'] = Hair.TextureIndex
                    SetPedHairColor(GetPlayerPed(-1), Hair.TextureIndex, PlayerData['haircolor'])
                end
                if Selected then 
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            RageUI.Visible(RMenu:Get('HVCClothing', 'main'), true) 
            Mask.Index = GetPedDrawableVariation(ped, 1)
            Mask.TextureIndex = GetPedTextureVariation(ped, 1)
            Hair.Index = GetPedDrawableVariation(ped, 2)
            if PlayerData then 
        ...
        if not inMarker and MenuOpen then
            ...
            RageUI.Visible(RMenu:Get('HVCClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('HVCClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('HVCClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
