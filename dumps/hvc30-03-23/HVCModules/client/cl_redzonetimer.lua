...
local HVCRedzones = {
    ...
    -- ["Rig"] = {vector3(-1705.81, 8886.57, 28.72),92.0}, -- oil rig
...
Citizen.CreateThread(function()
    while true do
        ...
        HVCIfInRedzone = false
        for redZone,v in pairs(HVCRedzones) do
                ...
                while not startRed do
                    ...
                    while getNonZDistance(playerCoords,zoneVector) <= zoneRadius do
                        ...
                        if HVCTimer == 0 then
                            ...
                            DrawAdvancedText(0.931, 0.914, 0.005, 0.0028, 0.49, "Combat Timer: " .. HVCTimer .. " seconds", 244, 11, 27, 255, 7, 0)
