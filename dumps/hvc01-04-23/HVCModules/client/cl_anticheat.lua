...
--         oldPos = newPos
--         if dist > 6 and not IsPedFalling(playerPed) and not IsPedInParachuteFreeFall(playerPed) and not IsPedRagdoll(playerPed) and not isNoCliping() and not isSpectator() then
