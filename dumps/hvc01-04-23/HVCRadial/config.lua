...
RegisterNetEvent("HVC:PoliceClockedOn")
AddEventHandler("HVC:PoliceClockedOn", function(MetPD)
    onduty = MetPD
end)
...
rootMenuConfig =  {
    {
        ...
        subMenus = { "general:askid","civ:cpr", "general:searchnearest", 'general:givemoney'}
    },
    {
        id = "police-action",
...
newSubMenus = {
    ['vehmenu:openboot'] = {
        ...
        functionName = "HVCInventory:OpenBoot"
    }, 
    ['vehmenu:lockcar'] = {
        title = "Lock Car",
        icon = "#impound-vehicle",
        functionName = "HVCVeh:lockcar"
    },
    ['vehmenu:lockpick'] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "HVC:InitLockPicking"
    },
    ['vehmenu:cleancar'] = {
        title = "Clean Your Vehicle",
        icon = "#general-keys-give",
        functionName = "HVC:CleanCar"
    },
    ['vehmenu:repaircar'] = {
        title = "Repair Your Vehicle",
        icon = "#general-keys-give",
        functionName = "Vrxith:RepairVehicle"
    },
    ['police:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
        functionName = 'HVCClient:ReviveCPR'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "HVC:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "HVC:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "HVC:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "HVC:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "HVC:SearchNearest"
    },
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'HVC:Jail'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "HVC:Unjail"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'HVC:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'HVC:SeizeWeapons'
    }, 
    ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'HVC:SeizeItems'
    }, 
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
...
--[[     ['cuffs:remmask'] = {
    ...
    ['police:escort'] = {
        title = "Drag Player",
        icon = "#general-escort",
        functionName = 'HVC:Drag'
    },
    ['police:putinvehicle'] = {
        title = "Put In Vehicle",
        icon = "#general-put-in-veh",
        functionName = "HVC:putinveh"
    },
    ['police:unseatnearest'] = {
        title = "Unseat Player",
        icon = "#general-unseat-nearest",
        functionName = "HVC:takeoutveh"
    },
    ['police:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
