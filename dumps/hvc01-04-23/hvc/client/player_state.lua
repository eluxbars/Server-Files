...
function tHVC.isInRedzone()
  local Coords = GetEntityCoords(PlayerPedId())
  if #(Coords - vector3(3558.87, 3719.74, 37.75)) < 180.0 then --in H
    return true;
  elseif #(Coords - vector3(2530.03, -382.58, 92.99)) <  123.0 then -- Old LSD
    return true;
  elseif #(Coords - vector3(-1109.77, 4922.12, 217.46)) < 120.0 then -- Large
    return true;
  elseif #(Coords - vector3(1485.78, 6330.06, 23.70)) <  92.0 then -- Rebel
    return true;
  elseif #(Coords - vector3(-586.41, -1599.27, 27.01)) < 92.0 then -- DMT
    return true;
  end
