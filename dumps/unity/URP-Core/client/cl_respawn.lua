local Housing = module("URP-Core", "cfg/cfg_homes")
...
RegisterNetEvent("URP:PolicePerms")
AddEventHandler("URP:PolicePerms",function(pd)
    hasPD = pd
end)
RegisterNetEvent("URP:RebelPerms")
AddEventHandler("URP:RebelPerms",function(rebel)
    hasRebel = rebel
end)
RegisterNetEvent("URP:VIPPerms")
AddEventHandler("URP:VIPPerms",function(VIP)
    hasVIP = VIP
end)
...
RegisterNetEvent("URP:StartRespawnCam")
AddEventHandler("URP:StartRespawnCam",function()
    inRedZone = false
    inCam = true
    inMenu = true
    DoScreenFadeIn(500)
...
RegisterNetEvent("URP:HousingTable")
AddEventHandler("URP:HousingTable",function(houses)
    housetable = houses
end)