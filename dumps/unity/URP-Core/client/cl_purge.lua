...
RegisterCommand("purge", function(source,args,rawCommand)
    purge = not purge
    print(purge)
    TriggerServerEvent('URP:activatePurgeSV', purge)
end)

RegisterCommand("testgun", function(source,args,rawCommand)
    if purge then
        TriggerServerEvent('URP:purgeRespawn')
    end
end)
...
RegisterNetEvent("URP:activatePurge")
AddEventHandler("URP:activatePurge", function()
