...
AmmoCFG.coords = {
    ...
    [0] = {
    ped = {281.8945, 6789.336, 15.68201},
    marker = {281.8945, 6789.336, 15.68201},
    },
}
...
AmmoCFG.ammo = {
    ammotypes = {
        ...
        {name = ".357 Bullets", price = 500, id = ".357 Bullets"},
        {name = "12 Gauge Shells", price = 750, id = "12 Gauge"},
        {name = "7.62mm Bullets", price = 1000, id = "7.62 Bullets"},
        {name = ".308 Sniper Rounds", price = 1500, id = ".308 Bullets"},
        {name = "NATO 5.56 Bullets", price = 3000, id = "NATO 5.56"},
...
RageUI.CreateWhile(1.0, RMenu:Get('ammo', 'main'), nil, function()
    ...
    RageUI.IsVisible(RMenu:Get('ammo', 'amount'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("Confirm Purchase" , "Ammo Name: ~g~" ..AmmoName.. "\n~w~Ammo Amount: ~g~" ..Index.."\n~w~Total Price: ~g~£"..Comma(AmmoPrice*Index), {RightLabel = "→→→"}, true, function(Hovered, Active, Selected)
            ...
            if (Selected) then
                TriggerServerEvent("URP:PurchaseAmmo", Index, AmmoPrice*Index, AmmoID, AmmoName)
            end
...
Citizen.CreateThread(function()
    blip = AddBlipForCoord(281.8945, 6789.336, 15.68201)
...
local Amz = AddBlipForRadius(281.8945, 6789.336, 15.68201, 75.0) -- Ammo Zone
SetBlipColour(Amz, 3)
