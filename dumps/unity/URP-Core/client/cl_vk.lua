...
RMenu.Add('PDTP', 'main', RageUI.CreateMenu("Teleport Menu", "~b~Teleport Menu", GetRageUIMenuWidth(),GetRageUIMenuHeight()))
RMenu.Add('PDTOMPD', 'main', RageUI.CreateMenu("Teleport Menu", "~b~Teleport Menu", GetRageUIMenuWidth(),GetRageUIMenuHeight()))
