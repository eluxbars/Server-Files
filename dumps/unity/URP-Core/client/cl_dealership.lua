...
dealership.main = {
    {spawncode = "warthogheli", vehname = "hog heli",  price = 0, desciption = "200kg heli"},
    {spawncode = "fiestaraid", vehname = "fiestaraid",  price = 0, desciption = "free lock"},
}

dealership.police = {
    {spawncode = "polm2", vehname = "unmarked m2", price = 1, desciption = ""},
    {spawncode = "seweyy", vehname = "Unmarked RS3 V2 2021", price = 1, desciption = ""},
    {spawncode = "pdpriorm5", vehname = "BMW M5 prior", price = 1, desciption = ""},
    {spawncode = "riotvan", vehname = "Mercedes Sprinter Marked", price = 1, desciption = ""},
    {spawncode = "jagrsmarked", vehname = "Jaguar XF-RS Marked", price = 1, desciption = ""},
    {spawncode = "riot", vehname = "Police Riot Van", price = 1, desciption = ""},
    {spawncode = "bmw540marked", vehname = "BMW 5 Series", price = 1, desciption = ""},
    {spawncode = "polrange", vehname = "Range Rover Marked", price = 1, desciption = ""},
    {spawncode = "polrange2", vehname = "Range Rover unMarked", price = 1, desciption = ""},
    {spawncode = "artxzz", vehname = "ARTXZZ Jaguar XE-S Interceptor Marked", price = 1},
    {spawncode = "npas", vehname = "npas", price = 1},
    {spawncode = "polbird", vehname = "Police Little Bird", price = 1},
    {spawncode = "npas2", vehname = "poice heli 2", price = 1},
    {spawncode = "npas4", vehname = "npas heli", price = 1},
    {spawncode = "markeda4arv", vehname = "Audi A4", price = 1},
    {spawncode = "polinsignia", vehname = "Vauxhall Insignia", price = 1},
    {spawncode = "polsco19", vehname = "SCO19 Marked X5 ARV", price = 1},

}


dealership.rebel = {
    {spawncode = "m2keyvany	", vehname = "m2keyvany	", price = 3000000, desciption = ""},
