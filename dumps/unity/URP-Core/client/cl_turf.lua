...
RegisterNetEvent('URP:TakenTurf')
AddEventHandler('URP:TakenTurf', function(isnTurf)
...
RegisterNetEvent('URP:OutOfZone')
AddEventHandler('URP:OutOfZone', function(isnTurf)
	inTurf = false

	-- TriggerEvent('chatMessage', '[URP Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you will receive nothing.")
...
RegisterNetEvent('URP:PlayerDied')
AddEventHandler('URP:PlayerDied', function(isnTurf)
	inTurf = false
	-- TriggerEvent('chatMessage', '[URP Turf System]:', {255, 34, 0}, "The turf cap was cancelled, you died!")
...
RegisterNetEvent('URP:TurfComplete')
AddEventHandler('URP:TurfComplete', function(reward, name)
	inTurf = false
	-- TriggerEvent('chatMessage', '[URP Turf System]:', {255, 34, 0}, "Turf capture sucessful, you received:^2 £" .. reward)
