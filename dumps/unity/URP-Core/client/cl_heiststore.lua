-- local cfg = module("URP-Core", "cfg/cfg_stores")
-- local inMenu = false
...
-- RMenu.Add("URP:HeistShops", "main", RageUI.CreateMenu("Heist Store", "~b~Heist Store", 1350, 50))
-- RMenu.Add("URP:HeistShops", "sub", RageUI.CreateSubMenu(RMenu:Get("URP:HeistShops", "main"), "Heist Store", "~b~Confirm Purchase", 1350, 50))

-- RageUI.CreateWhile(1.0, RMenu:Get("URP:HeistShops", "main"), nil, function()
--     RageUI.IsVisible(RMenu:Get("URP:HeistShops", "main"), true, false, true, function()
...
--                     end
--                 end, RMenu:Get("URP:HeistShops", "sub", true))
--             end
--         end
--     end, function() 
--     end)

--     RageUI.IsVisible(RMenu:Get("URP:HeistShops", "sub"), true, false, true, function()
...
--                 if Selected then
--                     TriggerServerEvent("URP:SellHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("URP:HeistShops", "main", true))
--         else
...
--                 if Selected then
--                     TriggerServerEvent("URP:BuyHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("URP:HeistShops", "main", true))
--         end
...
--                 inMenu = true
--                 currentShop = k
--                 RageUI.Visible(RMenu:Get("URP:HeistShops", "main"), true)
--             end
--         end
