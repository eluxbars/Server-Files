local cfg = module("URPCars", "cfg/cfg_speedcap")
...
cityHall = {x = 380.37829589844, y = 6.8610696792603, z = 91.304573059082}
...
VIPIsland = {x = -2184.1535644531, y = 5192.87109375, z = 18.235437393188}
...
local blips = {
	...
	{title="Safe Zone", colour=2, id=1, pos=vector3(legionJD.x, legionJD.y, legionJD.z),dist=35,nonRP=false,setBit=false},
	...
	{title="Safe Zone", colour=2, id=1, pos=vector3(legionGarage.x, legionGarage.y, legionGarage.z),dist=35,nonRP=false,setBit=false},
...
if not purge then
	...
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
	local pos = AddBlipForRadius(154.30529785156,-1049.1298828125,29.243709564209, 35.0) -- jd green 
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 130)
	local pos = AddBlipForRadius(108.45377349854,-1943.3997802734,20.803728103638, 35.0) -- Green circle at weed
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 70)
	local pos = AddBlipForRadius(246.30143737793,-782.50170898438,30.573167800903, 35.0) -- legion garage
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
	local pos = AddBlipForRadius(-2341.7902832031,284.36248779297,169.4672088623, 40.0) -- VIPtp
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
	local pos = AddBlipForRadius(-2184.1535644531,5192.87109375,18.235437393188, 130.0) -- VIPIsland
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
	local pos = AddBlipForRadius(380.37829589844,6.8610696792603,91.304573059082, 60.0) -- town hall
	SetBlipColour(pos, 2)
	SetBlipAlpha(pos, 170)
