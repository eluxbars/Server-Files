...
RMenu.Add('policelarge', 'main', RageUI.CreateMenu("", "~b~URP Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "sub", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~URP Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~URP Police Armoury", 1300, 50, "banners", "police"))
