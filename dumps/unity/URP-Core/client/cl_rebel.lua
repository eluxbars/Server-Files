...
RMenu.Add('RebelMenu', 'main', RageUI.CreateMenu("", "~r~URP Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~URP Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "adrebel", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~URP Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "armourplate", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~URP Rebel", 1300, 50, "banners", "rebel"))
...
RegisterNetEvent("URP:PlaySound")
AddEventHandler("URP:PlaySound", function(status)
    if status == 1 then 
