        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              URPcfgdrugsServer.CanProcessWeed({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then

          


                  URPcfgdrugsServer.ProcessWeed()
...
function sellingWeedUnits()
    URPcfgdrugsServer.SellWeed({tonumber(1)})
    return false
end
