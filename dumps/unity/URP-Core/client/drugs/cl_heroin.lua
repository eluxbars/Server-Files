          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                URPcfgdrugsServer.HeroinGather ()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              URPcfgdrugsServer.CanProcessHeroin({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  URPcfgdrugsServer.ProcessHeroin()
...
function sellingHeroinUnits()
    URPcfgdrugsServer.SellHeroin({tonumber(1)})
    return false
end
