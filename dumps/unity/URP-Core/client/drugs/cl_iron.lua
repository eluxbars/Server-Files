        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              URPcfgdrugsServer.IronCanProcess({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  URPcfgdrugsServer.IronDoneProcessing()
...
function sellingIronUnits()
     URPcfgdrugsServer.SellIronJob({tonumber(1)})
    return false
end
