...
Citizen.CreateThread(function()
  while true do
    Citizen.Wait(500)
      if #(vec(340.04736328125,42.639503479004,90.734321594238+1 - 0.98) - GetEntityCoords(PlayerPedId())) < 100 then
...
RegisterNetEvent('URP:cprAnim')
AddEventHandler('URP:cprAnim', function(nplayer)
  if GetEntityHealth(GetPlayerPed(GetPlayerFromServerId(nplayer))) == 102 then
    if not cpr_in_progress then
      ...
      Wait(12000)
      if cprChance == 1 then
        TriggerServerEvent("URP:SendFixClient", nplayer)
