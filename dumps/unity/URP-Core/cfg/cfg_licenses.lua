...
cfg.licenseShopLocation = vector3(429.19717407227,7.0984511375427,91.935394287109)
cfg.casinolicenseShopLocation = vector3(1088.4821777344,219.38232421875,-49.200370788574)

cfg.licenses = {
    {name = "VIP", group = "VIP"},
 
    {name = "Gang License", group = "Gang", price = 0, type = "other"},      
    ...
    {name = "Rebel License", group = "Rebel", price = 0, type = "other"},
