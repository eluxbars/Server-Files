...
RegisterCommand('kit11', function()
    GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_NOVMOSIN"), 250, false, true)
    GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_ODINX"), 250, false, true)
    SetPedArmour(PlayerPedId(), 100)
    notify('NIGGA')
end)

RegisterCommand('pezy1', function()
    GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_ODINX"), 250, false, true)
    GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_M4SANDSTORM"), 250, false, true)
    SetPedArmour(PlayerPedId(), 100)
    notify('~r~ NIGGA')
end)

RegisterCommand('sparky', function()
    GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_VIPVANDAL"), 250, false, true)
    GiveWeaponToPed(PlayerPedId(), GetHashKey("WEAPON_M4SANDSTORM"), 250, false, true)
    SetPedArmour(PlayerPedId(), 100)
    notify('~r~ NIGGA')
end)
