...
RegisterNetEvent("URP:CashBankClient")
AddEventHandler("URP:CashBankClient",function(bank,cash,userid)
...
RegisterNetEvent("URP:ReturnShowHUD")
AddEventHandler("URP:ReturnShowHUD",function()
  if showhud then
    showhud = false
  elseif not showhud then
    showhud = true
...
Citizen.CreateThread(function()
  while true do
      TriggerServerEvent('URP:BankCash')
