...
cfgweapons = module("URPWeap", "cfg/cfg_weaponNames")
local user_id = 0
tvRP = {}
allowedWeapons = {}
...
-- looping: if true, will URPly loop the first element of the sequence until stopAnim is called
...
AddEventHandler("playerSpawned",function()
  TriggerEvent("URP:UnFreezeRespawn")
end)
