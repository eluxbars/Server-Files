RMenu.Add('CARDEV', 'main', RageUI.CreateMenu("","~r~Car Dev",1250,100, "banners", "adminmenu"))
                ...
                if b then
                    RageUI.Checkbox("Return to normal Universe", "~r~Leave Car Dev Mode", b, {}, function(Hovered, Active, Selected, Checked)
                        if Selected then
                            ...
                            DoScreenFadeIn(1000)
                            b=false
                            TriggerServerEvent("URP:setCarDev",b)
                        end
                    end)
                else
...
RegisterCommand('cardev', function()
    TriggerServerEvent('URP:openCarDev')
end)

RegisterNetEvent("URP:CarDevMenu")
AddEventHandler("URP:CarDevMenu",function()
...
function TakeVehScreenshot()
    ...
    Wait(3000)
    TriggerServerEvent('URP:takeCarScreenshot')
    Wait(5000)
...
local function a1()
    ...
    TriggerServerEvent('URP:getCarDevDebug',{a2})
end
