...
AddEventHandler("playerSpawned",function()
    local h = true
    if h then 
        TriggerServerEvent("URP:GetGangData")
    end 
end)
RegisterNetEvent("URP:GotGangData")
AddEventHandler("URP:GotGangData",function(i,j,k,PO)
    if i==nil then 
        PlayerIsInGang=false 
    else 
        PlayerIsInGang=true
...
RegisterNetEvent("URP:disbandedGang")
AddEventHandler("URP:disbandedGang",function()
    showGangUI=false
    showNoGangUI=true
    PlayerIsInGang=false
    ...
    TriggerEvent("URP:ForceRefreshData")
end)
RegisterNetEvent("URP:ForceRefreshData")
AddEventHandler("URP:ForceRefreshData",function()
    TriggerServerEvent("URP:GetGangData")
end)
RegisterNetEvent("URP:InviteRecieved")
AddEventHandler("URP:InviteRecieved",function(o,Q)
    URPGangInvites[URPGangInviteIndex]=Q
    URPGangInviteIndex=URPGangInviteIndex+1
    Notify(o)
end)
RegisterNetEvent("URP:gangNameNotTaken")
AddEventHandler("URP:gangNameNotTaken",function()
    showNoGangUI=false
    showGangUI=true
    PlayerIsInGang=true 
end)
function func_drawGangUI()
    if showNoGangUI then 
        ...
        DrawAdvancedText(0.558,0.303,0.005,0.0028,0.539,"URP Gangs",255,255,255,255,7,0)
        ...
        for p,q in pairs(URPGangInvites)do 
        ...
        if CursorInArea(0.35,0.415,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if createGangName~=nil and createGangName~="null"and createGangName~=""then 
                    TriggerServerEvent("URP:CreateGang",createGangName)
                else 
        ...
        if CursorInArea(0.435,0.51,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedGangInvite~=nil then 
                    selectedGangInvite=URPGangInvites[selectedGangInvite]
                    local perm1s = getUserId()
                    TriggerServerEvent("URP:addUserToGang",selectedGangInvite,perm1s)
                    URPGangInvites={}
                    showNoGangUI=false
                    URPGangInviteIndex=0
                    showGangUI=true
    ...
    if showFundsGangUI then 
        ...
        DrawAdvancedText(0.591,0.378,0.005,0.0028,0.48,"URP gang - funds",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if amount~=nil then 
                    if closeToBarclays()then 
                        TriggerServerEvent("URP:depositGangBalance",amount)
                    end 
                else 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if amount~=nil then 
                    if gangPermission>=3 then 
                        if closeToBarclays()then 
                            TriggerServerEvent("URP:withdrawGangBalance",amount)
                        end 
                    else 
    ...
    if showMembersGangUI then 
        ...
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"URP gang - members",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("URP:PromoteUser",gangID,tonumber(selectedMember))
                    else 
        ...
        if CursorInArea(0.6182,0.6822,0.4138,0.4694)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("URP:DemoteUser",gangID,selectedMember)
                    else 
                ...
                if selectedMember~=nil then 
                    if gangPermission>=3 then 
                        if YesNoConfirm()then 
                            TriggerServerEvent("URP:kickMemberFromGang",gangID,selectedMember)
                        end 
                    else 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if s~=nil then 
                    if gangPermission>=2 then 
                        TriggerServerEvent("URP:InviteUserToGang",gangID,s)
                    else 
    ...
    if showLogsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"URP gang - logs",255,255,255,255,7,0)
    ...
    if showSettingsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"URP gang - settings",255,255,255,255,7,0)
        ...
        if CursorInArea(0.3187,0.3937,0.4712,0.5462)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                PlaySound(-1,"SELECT","HUD_FRONTEND_DEFAULT_SOUNDSET",0,0,1)
                if YesNoConfirm()then 
                    TriggerServerEvent("URP:memberLeaveGang",gangID)
                    PlayerIsInGang=false
                    showGangUI=false
                    showNoGangUI=true
                    showSettingsGangUI=false
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if gangPermission>=4 then 
                    if YesNoConfirm()==true and gangID~=nil then 
                        TriggerServerEvent("URP:DeleteGang",gangID)
                    end 
                else 
    ...
    if showTurfsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"URP gang - Turfs",255,255,255,255,7,0)
    ...
    if showGangUI then 
        ...
        DrawAdvancedText(0.591,0.399,0.005,0.0028,0.51,"URP Gangs",255,255,255,255,7,0)
...
RegisterNetEvent("URP:Notify")
AddEventHandler("URP:Notify",function(u)
    Notify(u)
end)
