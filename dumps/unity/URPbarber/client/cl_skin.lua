...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("URP:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("URP:setHairstyle")
AddEventHandler("URP:setHairstyle",function(hairstyle)
    if hairstyle then
...
Citizen.CreateThread(function()
	...
	for k, v in pairs(URPFaceDataBlips) do
