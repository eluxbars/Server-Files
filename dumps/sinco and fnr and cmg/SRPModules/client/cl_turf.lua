...
RegisterNetEvent('SRP:TakenTurf')
AddEventHandler('SRP:TakenTurf', function(isnTurf)
...
RegisterNetEvent('SRP:OutOfZone')
AddEventHandler('SRP:OutOfZone', function(isnTurf)
	inTurf = false
...
RegisterNetEvent('SRP:PlayerDied')
AddEventHandler('SRP:PlayerDied', function(isnTurf)
	inTurf = false
...
RegisterNetEvent('SRP:TurfComplete')
AddEventHandler('SRP:TurfComplete', function(reward, name)
	inTurf = false
