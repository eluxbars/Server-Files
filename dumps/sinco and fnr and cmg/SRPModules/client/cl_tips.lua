...
{ 
    ...
    prefix.."Place dsc.gg/srp5em in your discord status and then /redeem for a free £500,000",
}
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        num = math.random(1,#SRPTips)
        TriggerEvent('chatMessage',"", {255, 51, 51}, "" .. SRPTips[num], "ooc")
        Wait(600000)
    end
end)
