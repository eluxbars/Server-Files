          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                SRPcfgdrugsServer.HeroinGather ()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SRPcfgdrugsServer.CanProcessHeroin({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  SRPcfgdrugsServer.ProcessHeroin()
...
function sellingHeroinUnits()
    SRPcfgdrugsServer.SellHeroin({tonumber(1)})
    return false
end
