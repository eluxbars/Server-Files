        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SRPcfgdrugsServer.IronCanProcess({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  SRPcfgdrugsServer.IronDoneProcessing()
...
function sellingIronUnits()
     SRPcfgdrugsServer.SellIronJob({tonumber(1)})
    return false
end
