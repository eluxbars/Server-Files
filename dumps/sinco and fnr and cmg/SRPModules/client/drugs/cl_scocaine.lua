          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              TaskStartScenarioInPlace(ped, 'WORLD_HUMAN_GARDENER_PLANT', false, true)
                ...
                SRPcfgdrugsServer.CocaineGather()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SRPcfgdrugsServer.CocaineCanProcess({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  SRPcfgdrugsServer.CocaineDoneProcessing()
...
function sellingCocaineUnits()
     SRPcfgdrugsServer.SellCocaineJob({tonumber(1)})
    return false
end
