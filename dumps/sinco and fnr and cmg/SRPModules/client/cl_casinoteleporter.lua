...
RMenu.Add('casino_enter', 'casino', RageUI.CreateMenu("", "",GetRageUIMenuWidth(),GetRageUIMenuHeight(),"shopui_title_casino", "shopui_title_casino"))
RMenu:Get('casino_enter', 'casino'):SetSubtitle("~b~ENTER")
RMenu.Add('casino_exit', 'casino', RageUI.CreateMenu("", "",GetRageUIMenuWidth(),GetRageUIMenuHeight(),"shopui_title_casino", "shopui_title_casino"))
...
RageUI.CreateWhile(1.0, RMenu:Get('casino_exit', 'casino'), nil, function()
    RageUI.IsVisible(RMenu:Get('casino_exit', 'casino'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("Exit Diamond Casino", "",{ RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if (Hovered) then
...
RageUI.CreateWhile(1.0, RMenu:Get('casino_enter', 'casino'), nil, function()
    RageUI.IsVisible(RMenu:Get('casino_enter', 'casino'), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("Enter Diamond Casino", "",{ RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
            if (Hovered) then
