...
returnedMelee2 = {}
RMenu.Add('KnifeStoreMenu', 'main', RageUI.CreateMenu("", "~r~Knife Store", 1300, 50, "banners", "knife"))
RMenu.Add("KnifeStoreMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("KnifeStoreMenu", "main"), "", "~r~ Knife Store", 1300, 50, "banners", "knife"))
RMenu.Add("KnifeStoreMenu", "whietlistedmelees", RageUI.CreateSubMenu(RMenu:Get("KnifeStoreMenu", "main"), "", "~r~ Knife Store", 1300, 50, "banners", "knife"))
        ...
        RageUI.ButtonWithStyle("Purchase Weapon Body" , "Purchase "..currentMeleeName.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentMeleePrice)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                if HasPedGotWeapon(Ped, currentMeleeHash, false) then
                    ...
                    TriggerServerEvent('SRP:BuyKnife', currentMeleeHash)
                end
            end
        end)
    end, function()
        ...
        RageUI.ButtonWithStyle("Purchase Weapon Body" , "Purchase "..currentMeleeName1.." and Max Ammo", { RightLabel = "~g~£"..tostring(getMoneyStringFormatted(currentMeleePrice1)) }, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                if HasPedGotWeapon(Ped, currentMeleeHash1, false) then
                    ...
                    TriggerServerEvent('SRP:BuyWLKnife', currentMeleeHash1)
                end
            end
        end)
...
RegisterNetEvent('SRP:Error')
AddEventHandler('SRP:Error', function()
