...
RegisterNetEvent("SRP:PolicePerms")
AddEventHandler("SRP:PolicePerms",function(pd)
    hasPD = pd
end)
RegisterNetEvent("SRP:RebelPerms")
AddEventHandler("SRP:RebelPerms",function(rebel)
    hasRebel = rebel
end)
RegisterNetEvent("SRP:VIPPerms")
AddEventHandler("SRP:VIPPerms",function(vip)
    hasVIP = vip
end)
...
RegisterNetEvent("SRP:StartRespawnCam")
AddEventHandler("SRP:StartRespawnCam",function()
    inRedZone = false
    inCam = true
    inMenu = true
    DoScreenFadeIn(500)
...
RegisterNetEvent("SRP:HousingTable")
AddEventHandler("SRP:HousingTable",function(houses)
    housetable = houses
end)