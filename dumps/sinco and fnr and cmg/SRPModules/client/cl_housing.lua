...
local Housing = module("SRPModules", "cfg/cfg_homes")
...
RMenu.Add("JudHousing", "wardrobe", RageUI.CreateMenu("", "~b~Wardrobe", GetRageUIMenuWidth(),GetRageUIMenuHeight(),"hobannersme","homes"))
RMenu.Add("JudHousing", "wardrobesub", RageUI.CreateSubMenu(RMenu:Get("JudHousing", "wardrobe"), "", "~b~Wardrobe", GetRageUIMenuWidth(),GetRageUIMenuHeight(),"banners","homes"))
...
RageUI.CreateWhile(1.0, RMenu:Get("JudHousing", "main"), nil, function()
    ...
    RageUI.IsVisible(RMenu:Get("JudHousing", "main"), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("~r~Sell Home", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected)
            if Selected then
    ...
    RageUI.IsVisible(RMenu:Get("JudHousing", "wardrobesub"), true, false, true, function()
                ...
                for k, v in pairs(wardrobe) do
                    if k == currentOutfit then
                        ...
                        SetTimeout(50, function()
                            ...
                            TriggerServerEvent('SRP:changeHairStyle')
                        end)
                    end
                end
            end
        ...
        RageUI.ButtonWithStyle("~r~Remove Outfit", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected)
            if Selected then
