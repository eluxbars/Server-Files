...
RMenu.Add('policelarge', 'main', RageUI.CreateMenu("", "~b~SincoRP Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "sub", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~SincoRP Police Armoury", 1300, 50, "banners", "police"))
RMenu.Add("policelarge", "whitelistedguns", RageUI.CreateSubMenu(RMenu:Get("policelarge", "main"), "", "~b~SincoRP Police Armoury", 1300, 50, "banners", "police"))
