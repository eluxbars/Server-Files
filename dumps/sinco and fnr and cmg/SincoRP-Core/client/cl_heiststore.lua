-- local cfg = module("SincoRP-Core", "cfg/cfg_stores")
-- local inMenu = false
...
-- RMenu.Add("SincoRP:HeistShops", "main", RageUI.CreateMenu("Heist Store", "~b~Heist Store", 1350, 50))
-- RMenu.Add("SincoRP:HeistShops", "sub", RageUI.CreateSubMenu(RMenu:Get("SincoRP:HeistShops", "main"), "Heist Store", "~b~Confirm Purchase", 1350, 50))

-- RageUI.CreateWhile(1.0, RMenu:Get("SincoRP:HeistShops", "main"), nil, function()
--     RageUI.IsVisible(RMenu:Get("SincoRP:HeistShops", "main"), true, false, true, function()
...
--                     end
--                 end, RMenu:Get("SincoRP:HeistShops", "sub", true))
--             end
--         end
--     end, function() 
--     end)

--     RageUI.IsVisible(RMenu:Get("SincoRP:HeistShops", "sub"), true, false, true, function()
...
--                 if Selected then
--                     TriggerServerEvent("SincoRP:SellHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("SincoRP:HeistShops", "main", true))
--         else
...
--                 if Selected then
--                     TriggerServerEvent("SincoRP:BuyHeistItem", currentItemID, amount)
--                 end
--             end, RMenu:Get("SincoRP:HeistShops", "main", true))
--         end
...
--                 inMenu = true
--                 currentShop = k
--                 RageUI.Visible(RMenu:Get("SincoRP:HeistShops", "main"), true)
--             end
--         end
