...
RMenu.Add('RebelMenu', 'main', RageUI.CreateMenu("", "~r~SincoRP Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "sub", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~SincoRP Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "adrebel", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~SincoRP Rebel", 1300, 50, "banners", "rebel"))
RMenu.Add("RebelMenu", "armourplate", RageUI.CreateSubMenu(RMenu:Get("RebelMenu", "main"), "", "~r~SincoRP Rebel", 1300, 50, "banners", "rebel"))
...
RegisterNetEvent("SincoRP:PlaySound")
AddEventHandler("SincoRP:PlaySound", function(status)
    if status == 1 then 
