          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                SincoRPcfgdrugsServer.WeedGather ()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SincoRPcfgdrugsServer.CanProcessWeed({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then

          


                  SincoRPcfgdrugsServer.ProcessWeed()
...
function sellingWeedUnits()
    SincoRPcfgdrugsServer.SellWeed({tonumber(1)})
    return false
end
