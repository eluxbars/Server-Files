          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              TaskStartScenarioInPlace(ped, 'WORLD_HUMAN_GARDENER_PLANT', false, true)
                ...
                SincoRPcfgdrugsServer.CocaineGather()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SincoRPcfgdrugsServer.CocaineCanProcess({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  SincoRPcfgdrugsServer.CocaineDoneProcessing()
                ...
                if not canProcess then
                  vRP.notify({"~r~You do not have the required license."})
                    ...
                    if not ketAmount then
                      vRP.notify({"~r~You do not have enough Cocaine."})
                    end
                end
              end)
...
function sellingCocaineUnits()
     SincoRPcfgdrugsServer.SellCocaineJob({tonumber(1)})
    return false
end
