          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                SincoRPcfgdrugsServer.LSDGather()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SincoRPcfgdrugsServer.CanProcessLSD({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  SincoRPcfgdrugsServer.ProcessLSD()
...
function sellingLSDUnits()
    SincoRPcfgdrugsServer.SellLSD({tonumber(1)})
    return false
end
