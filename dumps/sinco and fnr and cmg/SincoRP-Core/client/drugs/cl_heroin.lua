          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                SincoRPcfgdrugsServer.HeroinGather ()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              SincoRPcfgdrugsServer.CanProcessHeroin({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  SincoRPcfgdrugsServer.ProcessHeroin()
...
function sellingHeroinUnits()
    SincoRPcfgdrugsServer.SellHeroin({tonumber(1)})
    return false
end
