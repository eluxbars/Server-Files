...
RegisterNetEvent("SincoRP:PoliceClockedOn")
AddEventHandler("SincoRP:PoliceClockedOn", function(MetPD)
    onduty = MetPD
end)
...
newSubMenus = {
    ['vehmenu:openboot'] = {
        ...
        functionName = "SincoRPInventory:OpenBoot"
    }, 
    -- ['vehmenu:lockcar'] = {
    --     title = "Lock Car",
    --     icon = "#impound-vehicle",
    --     functionName = "SincoRPVeh:lockcar"
    -- },
    -- ['vehmenu:repaircar'] = {
    --     title = "Repair Vehicle",
    --     icon = "#general-check-vehicle",
    --     functionName = "SincoRP:ComingSoon"
    -- }, 
    ['vehmenu:lockpick'] = {
        title = "Lockpick Vehicle",
        icon = "#general-keys-give",
        functionName = "SincoRP:LockPick2"
    },
    ['vehmenu:cleancar'] = {
        title = "Clean Your Vehicle",
        icon = "#general-keys-give",
        functionName = "SincoRP:CleanCar"
    },

    ['police:cpr'] = {
        title = "CPR",
        icon = "#general-check-over-target",
        functionName = 'SincoRP:reviveRadial'
    },
    ...
    ['vehmenupd:clampveh'] = {
        title = "Clamp Vehicle",
        icon = "#car-side",
        functionName = "SincoRP:ClampVehicle"
    },  
    ['vehmenupd:unclampveh'] = {
        title = "Unclamp Vehicle",
        icon = "#car-side",
        functionName = "SincoRP:UnClampVehicles"
    },  
    ['general:exitmenu'] = {
        title = "Exit Menu",
    ...
    ['general:emotes'] = {
        title = "Store Weapons",
        icon = "#general-emotes",
        functionName = "SincoRP:Storeweapons"
    },    
    ['general:askid'] = {
        title = "Ask For ID",
        icon = "#police-vehicle-plate",
        functionName = "SincoRP:AskID"
    },
    ['general:searchnearest'] = {
        title = "Search Player",
        icon = "#cuffs-check-inventory",
        functionName = "SincoRP:SearchPlr"
    },
    ['general:cpr'] = {
        title = "CPR",
        icon = "",
    ...
    ['general:givemoney'] = {
        ...
        functionName = "SincoRP:GiveMoney"
    },
...
--[[     ['general:checkvehicle'] = {
    ...
    ['general:putinvehicle'] = {
        ...
        functionName = "SincoRP:PutPlrInVeh"
    },
    ['general:unseatnearest'] = {
        title = "Unseat Nearest",
        icon = "#general-unseat-nearest",
        functionName = "SincoRP:TakeOutOfVehicle"
    },    
    ['general:flipvehicle'] = {
        title = "Flip Vehicle",
...
--[[     ['judge-raid:checkowner'] = {
    ...
    ['cuffs:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
        functionName = "SincoRP:policeCuff"
    }, 
    ...
    ['police:jail'] = {
        title = "Jail Near",
        icon = "#cuffs-cuff",
        functionName = 'SincoRP:JailPlayer'
    }, 
    ['police:unjail'] = {
        title = "Unjail Player",
        icon = "#cuffs-uncuff",
        functionName = "SincoRP:UnJailPlayer"
    }, 

    ['police:fine'] = {
        title = "Fine Nearest",
        icon = "#animation-money",
        functionName = 'SincoRP:Fine'
    }, 
    ['police:seize'] = {
        title = "Seize Weapons",
        icon = "#police-action-remove-weapons",
        functionName = 'SincoRP:SeizeWeapons2'
    }, 
--[[     ['police:seizeitems'] = {
        title = "Seize Items",
        icon = "#police-action-remove-weapons",
        functionName = 'SincoRP:SeizeWeapons'
    },  ]]
    ['cuffs:softcuff'] = {
        title = "Soft Cuff",
        icon = "#cuffs-cuff",
