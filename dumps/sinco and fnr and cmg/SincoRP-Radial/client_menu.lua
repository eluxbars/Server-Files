...
Citizen.CreateThread(function()
    TriggerServerEvent("SincoRP:PoliceCheckRadial")
    TriggerServerEvent("SincoRP:NHSCheckRadial")
end)
...
function Crosshair(enable)
    TriggerEvent("SincoRP:PutCrossHairOnScreen", enable)
    Display = enable;
end
...
RegisterNetEvent("SincoRP:CleanCar")
AddEventHandler("SincoRP:CleanCar",function()
