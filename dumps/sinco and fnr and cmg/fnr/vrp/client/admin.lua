...
function GiveStaffClothing()
    ...
    SetPedComponentVariation(B,4,146,4,0) -- [Legs]
    SetPedComponentVariation(B,8,15,1,0) -- [Undershirt]
    SetPedComponentVariation(B,6,134,0,00) -- [Shoes]
    if getStaffLevel() == 12 then
        SetPedComponentVariation(B,11,200,12,00) -- [Jacket]
    elseif getStaffLevel() == 11 then
        SetPedComponentVariation(B,11,200,11,00) -- [Jacket]
    elseif getStaffLevel() == 10 then
        SetPedComponentVariation(B,11,200,10,00) -- [Jacket]
    elseif getStaffLevel() == 9 then
        SetPedComponentVariation(B,11,200,9,00) -- [Jacket]
    elseif getStaffLevel() == 8 then
        SetPedComponentVariation(B,11,200,8,00) -- [Jacket]
    elseif getStaffLevel() == 7 then
        SetPedComponentVariation(B,11,200,7,00) -- [Jacket]
    elseif getStaffLevel() == 6 then
        SetPedComponentVariation(B,11,200,6,00) -- [Jacket]
    elseif getStaffLevel() == 5 then
        SetPedComponentVariation(B,11,200,5,00) -- [Jacket]
    elseif getStaffLevel() == 4 then
        SetPedComponentVariation(B,11,200,4,00) -- [Jacket]
    elseif getStaffLevel() == 3 then
        SetPedComponentVariation(B,11,200,3,00) -- [Jacket]
    elseif getStaffLevel() == 2 then
        SetPedComponentVariation(B,11,200,2,00) -- [Jacket]
    elseif getStaffLevel() == 1 then
        SetPedComponentVariation(B,11,200,1,00) -- [Jacket]
    end
end