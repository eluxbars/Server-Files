...
Citizen.CreateThread(function()
    TriggerServerEvent("SRP:PoliceCheckRadial")
    TriggerServerEvent("SRP:NHSCheckRadial")
end)
...
function Crosshair(enable)
    TriggerEvent("SRP:PutCrossHairOnScreen", enable)
    Display = enable;
end
...
RegisterNetEvent("SRP:CleanCar")
AddEventHandler("SRP:CleanCar",function()
