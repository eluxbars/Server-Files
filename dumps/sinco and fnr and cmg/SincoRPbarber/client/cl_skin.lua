...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("SincoRP:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("SincoRP:setHairstyle")
AddEventHandler("SincoRP:setHairstyle",function(hairstyle)
    if hairstyle then
...
Citizen.CreateThread(function()
	...
	for k, v in pairs(SincoRPFaceDataBlips) do
