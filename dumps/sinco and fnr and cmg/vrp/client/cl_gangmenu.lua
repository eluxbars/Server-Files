...
AddEventHandler("playerSpawned",function()
    local h = true
    if h then 
        TriggerServerEvent("SincoRP:GetGangData")
    end 
end)
RegisterNetEvent("SincoRP:GotGangData")
AddEventHandler("SincoRP:GotGangData",function(i,j,k,PO)
    if i==nil then 
        PlayerIsInGang=false 
    else 
        PlayerIsInGang=true
...
RegisterNetEvent("SincoRP:disbandedGang")
AddEventHandler("SincoRP:disbandedGang",function()
    showGangUI=false
    showNoGangUI=true
    PlayerIsInGang=false
    ...
    TriggerEvent("SincoRP:ForceRefreshData")
end)
RegisterNetEvent("SincoRP:ForceRefreshData")
AddEventHandler("SincoRP:ForceRefreshData",function()
    TriggerServerEvent("SincoRP:GetGangData")
end)
RegisterNetEvent("SincoRP:InviteRecieved")
AddEventHandler("SincoRP:InviteRecieved",function(o,Q)
    SincoRPGangInvites[SincoRPGangInviteIndex]=Q
    SincoRPGangInviteIndex=SincoRPGangInviteIndex+1
    Notify(o)
end)
RegisterNetEvent("SincoRP:gangNameNotTaken")
AddEventHandler("SincoRP:gangNameNotTaken",function()
    showNoGangUI=false
    showGangUI=true
    PlayerIsInGang=true 
end)
function func_drawGangUI()
    if showNoGangUI then 
        ...
        DrawAdvancedText(0.558,0.303,0.005,0.0028,0.539,"SincoRP Gangs",255,255,255,255,7,0)
        ...
        for p,q in pairs(SincoRPGangInvites)do 
        ...
        if CursorInArea(0.35,0.415,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if createGangName~=nil and createGangName~="null"and createGangName~=""then 
                    TriggerServerEvent("SincoRP:CreateGang",createGangName)
                else 
        ...
        if CursorInArea(0.435,0.51,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedGangInvite~=nil then 
                    selectedGangInvite=SincoRPGangInvites[selectedGangInvite]
                    local perm1s = getUserId()
                    TriggerServerEvent("SincoRP:addUserToGang",selectedGangInvite,perm1s)
                    SincoRPGangInvites={}
                    showNoGangUI=false
                    SincoRPGangInviteIndex=0
                    showGangUI=true
    ...
    if showFundsGangUI then 
        ...
        DrawAdvancedText(0.591,0.378,0.005,0.0028,0.48,"SincoRP gang - funds",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if amount~=nil then 
                    if closeToBarclays()then 
                        TriggerServerEvent("SincoRP:depositGangBalance",amount)
                    end 
                else 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if amount~=nil then 
                    if gangPermission>=3 then 
                        if closeToBarclays()then 
                            TriggerServerEvent("SincoRP:withdrawGangBalance",amount)
                        end 
                    else 
    ...
    if showMembersGangUI then 
        ...
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"SincoRP gang - members",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("SincoRP:PromoteUser",gangID,tonumber(selectedMember))
                    else 
        ...
        if CursorInArea(0.6182,0.6822,0.4138,0.4694)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("SincoRP:DemoteUser",gangID,selectedMember)
                    else 
                ...
                if selectedMember~=nil then 
                    if gangPermission>=3 then 
                        if YesNoConfirm()then 
                            TriggerServerEvent("SincoRP:kickMemberFromGang",gangID,selectedMember)
                        end 
                    else 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if s~=nil then 
                    if gangPermission>=2 then 
                        TriggerServerEvent("SincoRP:InviteUserToGang",gangID,s)
                    else 
    ...
    if showLogsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"SincoRP gang - logs",255,255,255,255,7,0)
    ...
    if showSettingsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"SincoRP gang - settings",255,255,255,255,7,0)
        ...
        if CursorInArea(0.3187,0.3937,0.4712,0.5462)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                PlaySound(-1,"SELECT","HUD_FRONTEND_DEFAULT_SOUNDSET",0,0,1)
                if YesNoConfirm()then 
                    TriggerServerEvent("SincoRP:memberLeaveGang",gangID)
                    PlayerIsInGang=false
                    showGangUI=false
                    showNoGangUI=true
                    showSettingsGangUI=false
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if gangPermission>=4 then 
                    if YesNoConfirm()==true and gangID~=nil then 
                        TriggerServerEvent("SincoRP:DeleteGang",gangID)
                    end 
                else 
    ...
    if showTurfsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"SincoRP gang - Turfs",255,255,255,255,7,0)
    ...
    if showGangUI then 
        ...
        DrawAdvancedText(0.591,0.399,0.005,0.0028,0.51,"SincoRP Gangs",255,255,255,255,7,0)
...
RegisterNetEvent("SincoRP:Notify")
AddEventHandler("SincoRP:Notify",function(u)
    Notify(u)
end)
