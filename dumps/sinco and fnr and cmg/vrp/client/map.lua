...
Citizen.CreateThread(
    function()
        while true do
            q = tvRP.getNearbyMarkers()
            Citizen.Wait(10000)
        end
    end
)
function tvRP.getNearbyMarkers()
    local N = {}
...
function tvRP.setArea(l, a, b, c, T, U)
...
RegisterCommand("nextblip",function()
    ...
    a4 = tvRP.addBlip(1103.9739990234, 211.95138549805, -49.440101623535, a5, 0, "Chips Cashier", 0.8, true)
end)
