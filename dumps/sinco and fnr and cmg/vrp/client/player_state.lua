...
Citizen.CreateThread(function()
  while true do
    ...
    if IsPlayerPlaying(PlayerId()) and state_ready then
        ...
        TriggerServerEvent('SincoRP:ChangeTattoos')
...
function tvRP.getDrawableTextures(c,f)
  local d,e=a(c)
  if d then 
...
function tvRP.setCustomization(h,j,k)
  if h then 
      local g=PlayerPedId()
      local l=nil;
