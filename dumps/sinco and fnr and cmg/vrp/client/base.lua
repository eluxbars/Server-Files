...
cfgweapons = module("SincoRPWeap", "cfg/cfg_weaponNames")
local user_id = 0
tvRP = {}
allowedWeapons = {}
...
local Q={}
local R={}
function tvRP.createArea(l,W,T,U,X,Y,Z,_)
...
-- looping: if true, will SincoRPly loop the first element of the sequence until stopAnim is called
...
AddEventHandler("playerSpawned",function()
  TriggerEvent("SincoRP:UnFreezeRespawn")
end)
