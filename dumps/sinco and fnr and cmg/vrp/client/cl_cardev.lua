                ...
                if b then
                    RageUI.Checkbox("Return to normal Universe", "~r~Leave Car Dev Mode", b, {}, function(Hovered, Active, Selected, Checked)
                        if Selected then
                            ...
                            DoScreenFadeIn(1000)
                            b=false
                            TriggerServerEvent("SincoRP:setCarDev",b)
                        end
                    end)
                else
...
RegisterCommand('cardev', function()
    TriggerServerEvent('SincoRP:openCarDev')
end)

RegisterNetEvent("SincoRP:CarDevMenu")
AddEventHandler("SincoRP:CarDevMenu",function()
...
function TakeVehScreenshot()
    ...
    Wait(3000)
    TriggerServerEvent('SincoRP:takeCarScreenshot')
    Wait(5000)
