...
vRPConfig.AdminCoolDown = true; -- Enables an admin cooldown on call admin.
...
vRPConfig.ServerName = "SincoRP" -- Controls the name that is displayed on warnings title etc.
